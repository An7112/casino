...
//                         <div className='flex-row'>
//                             <div className='row left'>
//                                 <span className="txt-ellipsis">New Zealand  (W)</span>
//                                 <span className="txt-ellipsis">Norway  (W)</span>
//                             </div>
//                             <div className='row right odds-img'>
//                                 <div>
//                                     <img className="homeTeamIcon" src="https://api.mfeedbo.com/api/m88feed/getteamicon/New_Zealand.png" />
//                                 </div>
//                                 <div>
//                                     <img className="awayTeamIcon" src="https://api.mfeedbo.com/api/m88feed/getteamicon/Norway.png" />
//                                 </div>
//                             </div>
//                         </div>
//                         <div className='grid-row'>
...
//                             <div className='line'>
//                             </div>
//                             <span className="odds-date">Jul 20</span>
//                         </div>
//                         <div className='flex-row'>
//                             <div className='row left'>
//                                 <span className="txt-ellipsis">New Zealand  (W)</span>
